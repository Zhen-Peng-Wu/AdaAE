    ...
    def process(self):
        ...
        if self.dataset == 'zinc_standard_agent':
            ...
            downstream_dir = [
                './data/chem_data/bace',
                './data/chem_data/bbbp',
                './data/chem_data/clintox',
                './data/chem_data/esol',
                './data/chem_data/freesolv',
                './data/chem_data/hiv',
                './data/chem_data/lipophilicity',
                './data/chem_data/muv',
                # './data/chem_data/pcba/processed/smiles.csv',
                './data/chem_data/sider',
                './data/chem_data/tox21',
                './data/chem_data/toxcast'
            ]
        ...
        # elif self.dataset == ''
            ...
            # smiles_path = './data/chem_data/mutag/raw/mutag_188_data.can'
            labels_path = os.path.join(self.root, 'raw', 'mutag_188_target.txt')
            # labels_path = './data/chem_data/mutag/raw/mutag_188_target.txt'
...
def merge_dataset_objs(dataset_1, dataset_2):
    ...
    new_dataset = MoleculeDataset(root='./data/chem_data/chembl_with_labels',
...
# input_path = './data/chem_data/clintox/raw/clintox.csv'
...
# input_path = './data/chem_data/esol/raw/delaney-processed.csv'
...
# root_path = './data/chem_data/chembl_with_labels'
...
def create_all_datasets():
    ...
    for dataset_name in downstream_dir:
        print(dataset_name)
        root = "./data/chem_data/" + dataset_name
        os.makedirs(root + "/processed", exist_ok=True)
        dataset = MoleculeDataset(root, dataset=dataset_name)
        print(dataset)

    dataset = MoleculeDataset(root="./data/chem_data/chembl_filtered", dataset="chembl_filtered")
    print(dataset)
    dataset = MoleculeDataset(root="./data/chem_data/zinc_standard_agent", dataset="zinc_standard_agent")
    print(dataset)
